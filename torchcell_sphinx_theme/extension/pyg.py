...
from torchcell_sphinx_theme.extension.logo import logo_role
from torchcell_sphinx_theme.extension.slack import SlackButton
...
def monkey_patch_find_autosummary_in_lines(
    ...
    for line in lines:
        if in_autosummary:
            ...
            # Begin of odified part by `torchcell_sphinx_theme` #####################
            ...
            if m:
                ...
                continue
            # End of modified part by `torchcell_sphinx_theme` ######################
